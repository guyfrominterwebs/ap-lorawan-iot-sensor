...
void initialize_radio()
{
  ...
  join_result = myLora.initABP("26011115", "C25A189E12F75C04A3F22239AF939CD9", "E09A87398EB1EDCF2CA7BA5B08CA8616");
...
void loop()
{
    ...
    myLora.tx("fuck you Jiska"); //one byte, blocking function
